...
class Tuple:
  ...
  """
  def __init__(self, x: float, y: float, z: float, w: int) -> Self:
    self.x = x
    self.y = y
    self.z = z
    self.w = w
...
class Point(Tuple):
  ...
  def __init__(self, x: float, y: float, z: float) -> Self:
