...
class TestMatrix:
  ...
  def test_matrix_eqality_identical(self):
    """ RT.Matrix equality with identical matrices """
    m1 = RT.Matrix([
      [1,2,3,4],
      [5,6,7,8],
      [9,8,7,6],
  ...
  def test_matrix_eqality_different(self):
    """ RT.Matrix equality with different matrices """
    m1 = RT.Matrix([
      [1,2,3,4],
      [5,6,7,8],
      [9,8,7,6],
  ...
  def test_matrix_multiply_tuple(self):
    ...
    b = RT.Tuple(1, 2, 3, 1)
    assert A * b == RT.Tuple(18, 24, 33, 1)
  ...
  def test_transpose_identity_matrix(self):
    ...
    A = RT.Matrix.identity().transpose()
    assert A == RT.Matrix.identity()
  ...
  def test_submatrix_3_3(self):
    ...
    assert A.submatrix(0, 2) == RT.Matrix([
      [-3,2],
      [0,6]
    ])
  ...
  def test_submatrix_4_4(self):
    ...
    assert A.submatrix(2, 1) == RT.Matrix([
      [-6,1,6],
      [-8,8,6],
      [-7,-1,1]
    ])
